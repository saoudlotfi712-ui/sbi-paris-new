...
import styles from "./FootballPage.module.css";
...
const products = [
  {
    name: "SBI PARIS Mercurial Pro FG",
    price: "89,90 €",
    oldPrice: "129,90 €",
    badge: "NOUVEAU",
    symbol: "👟",
  ...
  {
    name: "SBI PARIS Predator Elite FG",
    price: "99,90 €",
    oldPrice: "149,90 €",
    badge: "PROMO",
    symbol: "👟",
  ...
  {
    name: "SBI PARIS Crazyfast League FG",
    price: "79,90 €",
    oldPrice: "119,90 €",
    badge: "NOUVEAU",
    symbol: "👟",
  ...
  {
    name: "SBI PARIS Future Match FG/AG",
    price: "69,90 €",
    oldPrice: "99,90 €",
    badge: "PROMO",
    symbol: "👟",
        ...
        <section className={styles.content}>
          ...
          <section className={styles.top}>
            ...
            <div className={styles.hero}>
              <img
                src="/univers-sport/homme/banner/banner-homme.jpg"
                alt="SBI PARIS Univers Sport Homme Football"
              />
