...
import styles from "./PadelPage.module.css";
...
const products = [
  {
    name: "SBI PARIS Padel Court Pro",
    price: "89,90 €",
    oldPrice: "129,90 €",
    badge: "NOUVEAU",
    symbol: "👟",
  ...
  {
    name: "SBI PARIS Padel Elite One",
    price: "99,90 €",
    oldPrice: "149,90 €",
    badge: "PROMO",
    symbol: "👟",
  ...
  {
    name: "SBI PARIS Padel Speed Court",
    price: "79,90 €",
    oldPrice: "119,90 €",
    badge: "NOUVEAU",
    symbol: "👟",
  ...
  {
    name: "SBI PARIS Padel Match Pro",
    price: "84,90 €",
    oldPrice: "124,90 €",
    badge: "PROMO",
    symbol: "👟",
  ...
  {
    name: "SBI PARIS Padel Performance",
    price: "94,90 €",
    oldPrice: "139,90 €",
    badge: "NOUVEAU",
    symbol: "👟",
        ...
        <section className={styles.content}>
          <section className={styles.top}>
            <div className={styles.intro}>
              ...
              <p className={styles.description}>
                ...
                d&apos;équipements de padel pour
                combiner performance, confort et
            ...
            <div className={styles.hero}>
              <img
                src="/univers-sport/femme/products/padel.jpg"
                alt="SBI PARIS Padel"
              />
          ...
          >
            ...
            <div className={styles.paginationBar}>
              <p>
                Affichage de 1 à 12 sur 72 produits
              </p>
