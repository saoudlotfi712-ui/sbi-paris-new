...
const products = [
  ...
  {
    name: "SBI PARIS Performance Run",
    price: "94,90 €",
    oldPrice: "139,90 €",
    badge: "NOUVEAU",
    symbol: "👟",
        ...
        <aside className={styles.sidebar}>
          ...
          <nav className={styles.disciplineNav}>
            {disciplines.map((item) => {
              const active = item.name === "Running";
          ...
          <div className={styles.sidebarServices}>
            ...
            <div>
              ...
              <p>
                ...
                <small>7j/7 à votre écoute</small>
              </p>
            </div>
          </div>
        </aside>
        ...
        <section className={styles.content}>
          <section className={styles.top}>
            <div className={styles.intro}>
              ...
              <p className={styles.description}>
                ...
                d&apos;équipements de running pour
                améliorer votre confort, votre vitesse
                et vos performances à chaque course.
              </p>
            </div>

            <div className={styles.hero}>
              <img
                src="/univers-sport/femme/products/running.jpg"
                alt="SBI PARIS Running"
              />
          ...
          >
            ...
            <div className={styles.paginationBar}>
              <p>
                Affichage de 1 à 12 sur 94 produits
              </p>
