...
const products = [
  ...
  {
    name: "SBI PARIS Match Performance",
    price: "84,90 €",
    oldPrice: "124,90 €",
    badge: "PROMO",
    symbol: "👟",
  ...
  {
    name: "SBI PARIS Grand Court Pro",
    price: "94,90 €",
    oldPrice: "139,90 €",
    badge: "NOUVEAU",
    symbol: "👟",
        ...
        <section className={styles.content}>
          <section className={styles.top}>
            <div className={styles.intro}>
              ...
              <p className={styles.description}>
                ...
                d&apos;équipements de tennis pour
                associer performance, précision et
                élégance sur tous les courts.
              </p>
            </div>

            <div className={styles.hero}>
              <img
                src="/univers-sport/femme/products/tennis.jpg"
                alt="SBI PARIS Tennis"
              />
          ...
          >
            ...
            <div className={styles.paginationBar}>
              <p>
                Affichage de 1 à 12 sur 86 produits
              </p>
